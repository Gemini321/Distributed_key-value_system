...
type LogEntry struct {
	Op                   OperationType `protobuf:"varint,1,opt,name=Op,proto3,enum=KVService.OperationType" json:"Op,omitempty"`
	KeyVal               *KV           `protobuf:"bytes,2,opt,name=KeyVal,proto3" json:"KeyVal,omitempty"`
	Term                 int64         `protobuf:"varint,3,opt,name=Term,proto3" json:"Term,omitempty"`
	ChanId               int64         `protobuf:"varint,4,opt,name=ChanId,proto3" json:"ChanId,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *LogEntry) GetOp() OperationType {
	if m != nil {
		return m.Op
	}
...
func (m *LogEntry) GetChanId() int64 {
	if m != nil {
		return m.ChanId
	}
	return 0
...
func init() {
	proto.RegisterEnum("KVService.OperationType", OperationType_name, OperationType_value)
...
var fileDescriptor_2113408249da62ec = []byte{
	...
	,
}
